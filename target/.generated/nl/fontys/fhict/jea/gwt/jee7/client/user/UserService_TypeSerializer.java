...
public class UserService_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static native MethodMap loadMethodsNative() /*-{
    ...
    result["nl.fontys.fhict.jea.gwt.jee7.client.user.LoginException/2497480275"] = [
        @nl.fontys.fhict.jea.gwt.jee7.client.user.LoginException_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @nl.fontys.fhict.jea.gwt.jee7.client.user.LoginException_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lnl/fontys/fhict/jea/gwt/jee7/client/user/LoginException;),
      ];
  ...
  private static native JsArrayString loadSignaturesNative() /*-{
    ...
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@nl.fontys.fhict.jea.gwt.jee7.client.user.LoginException::class)] = "nl.fontys.fhict.jea.gwt.jee7.client.user.LoginException/2497480275";
