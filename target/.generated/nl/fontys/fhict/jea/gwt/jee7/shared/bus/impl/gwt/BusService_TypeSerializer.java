...
public class BusService_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static native MethodMap loadMethodsNative() /*-{
    ...
    result["nl.fontys.fhict.jea.gwt.jee7.shared.bus.test.CurrentTime/1395124728"] = [
        @nl.fontys.fhict.jea.gwt.jee7.shared.bus.test.CurrentTime_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @nl.fontys.fhict.jea.gwt.jee7.shared.bus.test.CurrentTime_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lnl/fontys/fhict/jea/gwt/jee7/shared/bus/test/CurrentTime;),
      ];
  ...
  private static native JsArrayString loadSignaturesNative() /*-{
    ...
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@nl.fontys.fhict.jea.gwt.jee7.shared.bus.test.CurrentTime::class)] = "nl.fontys.fhict.jea.gwt.jee7.shared.bus.test.CurrentTime/1395124728";
    return result;
  }-*/;
  
  public BusService_TypeSerializer() {
